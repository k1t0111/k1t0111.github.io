...
```java
package com.example.myapplication;import android.os.Bundle;import android.util.Log;import android.view.View;import android.widget.Button;import androidx.appcompat.app.AppCompatActivity;public class MainActivity extends AppCompatActivity {
    ...
    @Override    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        btnHelloWorld.setOnClickListener(new View.OnClickListener()
        {
            ...
            {
                // 打印日志到 Logcat                Log.d(TAG, "Hello World");
            }
        });
    }}
```

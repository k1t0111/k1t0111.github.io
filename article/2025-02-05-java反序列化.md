...
public class Employee implements java.io.Serializable{
    private String name;
    private int  old;
    // 无法被反序列化属性      public transient int address;
...
```java
package org.com.serial;import java.io.*;public class SerializeDemo {
...
```java
package org.com.serial;import java.io.ObjectInputStream;public class Employee implements java.io.Serializable{
    private String name;
    private int  old;
    // 无法被反序列化属性    public transient int address;
